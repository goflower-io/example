...
const (
	...
	UserService_ListUsersMore_FullMethodName = "/UserService/ListUsersMore"
)
...
type UserServiceClient interface {
	...
	ListUsersMore(ctx context.Context, in *ListUsersMoreReq, opts ...grpc.CallOption) (*ListUsersMoreResp, error)
}
...
func (c *userServiceClient) ListUsersMore(ctx context.Context, in *ListUsersMoreReq, opts ...grpc.CallOption) (*ListUsersMoreResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListUsersMoreResp)
	err := c.cc.Invoke(ctx, UserService_ListUsersMore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	ListUsersMore(context.Context, *ListUsersMoreReq) (*ListUsersMoreResp, error)
...
func (UnimplementedUserServiceServer) ListUsersMore(context.Context, *ListUsersMoreReq) (*ListUsersMoreResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListUsersMore not implemented")
}
...
func _UserService_ListUsersMore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListUsersMoreReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).ListUsersMore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_ListUsersMore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ListUsersMore(ctx, req.(*ListUsersMoreReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListUsersMore",
			Handler:    _UserService_ListUsersMore_Handler,
		},
	},
