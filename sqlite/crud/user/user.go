...
const (
	...
	CtimeOp = xsql.FieldOp[int64](Ctime)

	MtimeOp = xsql.FieldOp[int64](Mtime)
)
...
func (u *Updater) SetCtime(arg int64) *Updater {
	u.Set(Ctime, arg)
	return u
}

func (u *Updater) AddCtime(arg interface{}) *Updater {
	u.Add(Ctime, arg)
	return u
}

func (u *Updater) SetMtime(arg int64) *Updater {
	u.Set(Mtime, arg)
	return u
}

func (u *Updater) AddMtime(arg interface{}) *Updater {
	u.Add(Mtime, arg)
	return u
}
